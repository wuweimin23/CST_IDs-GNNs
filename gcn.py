...
class GCN(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout=0.5, with_relu=True, with_bias=True):
        ...
        self.gc = GraphConvolution(nfeat, nhid, with_bias=with_bias)
...
class GCN_head(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout=0.5, with_relu=True, with_bias=True):
        super(GCN_head, self).__init__()

        self.gc = GraphConvolution(nhid, nclass, with_bias=with_bias)
        self.dropout = dropout
        self.with_relu = with_relu
